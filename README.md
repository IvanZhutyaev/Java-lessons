...
<b>При работе со Stream API важно понимать, что все операции с потоками бывают либо терминальными, либо промежуточными.<br>Промежуточные возвращают трансформированный поток.<br>Конечные или терминальные всегда возвращают конечный результат.</b>
